...
if __name__ == "__main__":
    ...
    new_metric = 'rc05_adj_copy_tag_v2_testtest'             # 새로 put할 metric 설정하는 변수 (원하는 metric명을 입력하면 된다.)
    progress_num = 0
    ...
    for modem_num in modem_list:
        ...
        while is_past(end, etime):
            ...
            query_result = tsdb_query(u, start, end, metric_in, led[get_tag_ref('led_modem_serial')], holiday)

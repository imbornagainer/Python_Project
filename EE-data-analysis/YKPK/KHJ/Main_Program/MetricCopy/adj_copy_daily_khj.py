...
def parse_args():
    ...
    parser.add_argument("-end", default='2016/07/30-00:00:00', help="end time input, like 2016/07/02-00:00:00")
...
if __name__ == "__main__":
    ...
    new_metric = 'rc05_adj_copy_test_tag_v7'        # 새로 put할 metric 설정하는 변수 (원하는 metric명을 입력하면 된다.)
    progress_num = 0
    ...
    for modem_num in modem_list:
        ...
        while is_past(end, etime):
            ...
            if recent == 'True':
                ...
                get_list_data = rtest(u, metric, tag, start, end)
            else:

        ...
        while is_past(end, last):
            ...
            for group in query_result:
                if USE_HTTP_API_PUT:
                    ...
                    #print 'group : %s' % group
                    tsdb_put_telnet(host, port, metric_out, group['dps'], group['tags'], 'led')
        led_count += 1

...
with open('/home/tinyos/devel/kdatahub/EE-data-analysis/lib/tools/count_list.json') as data_file:
...
def one_day_pattern (__url, __wm, __v, __st, __et, host, port, season):
    ...
    metric_in  = 'avg:rc05_ld_rate_season_v1'                    # get할 metric명
    __m = metric_in
    #metric_out 은 인자로 받음
    #metric_ref  = 'none:rc04_simple_data_v3'                      # get할 metric명
...
def run():
    ...
    __wm = 'rc05_ld_rate_season_daily_v1'      # put할 metric명
    __v = None

...
#                 put_unix_time = 1464705900  # unix_time = 16/06/01 00:00:00
#                 for k,v in a_day_avg.items():
#                     if ndays_long == days_long : continue
#                     ''' no rcv data, no input to DB '''
#                     #a_day_avg_cmp[k] = v / (days_long)
#                     #a_day_avg[k] = v / (1.0 * days_long - ndays_long)
#                     put_unix_time += 900
#                     #print a_day_avg[k]
#                     #sockWriteTSD( sock, __wm, put_unix_time, tmp , wtag)
...
def run():
    ...
    __wm = 'rc06_op_rate_daily_v3_testest'       # put할 metric명
    __v = None
